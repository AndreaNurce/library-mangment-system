...
@section('content')
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <form action="{{ route('books.loan.store', ['slug' => $book->slug]) }}" class="form-inline" method="POST">
                @csrf
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            <input class="form-control text-center mr-2 @error('copies') is-invalid @enderror" name="copies" id="copies" type="number" value="{{ old('copies', 1) }}" style="max-width: 5rem" max="{{ $availableBooks }}"/>
                            <button class="btn btn-primary flex-shrink-0" type="submit">Loan Book</button>
                        </div>
                        @error('copies')
