...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('admin.categories.create') }}" class="d-sm-inline-block btn btn-sm btn-outline-success shadow-sm">
                <i class="fas fa-plus fa-sm text-success-50"></i> Add Catgory
            </a>
        </div>
        <div class="card-body">
